                                ...
                                >
                                    <div className="relative overflow-hidden bg-gray-50">
                                        ...
                                        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-end p-4">
                                            <p className="text-white/90 text-[11px] font-medium mb-4 line-clamp-3 leading-relaxed italic">
                                                "{task.prompt}"
                                            </p>
                                            ...
                                            <div className="grid grid-cols-3 gap-2 mb-3">
                                                <button
                                                    ...
                                                    className="py-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl text-white flex flex-col items-center gap-1 hover:bg-white hover:text-indigo-600 transition-all"
                                                >
                                                    <Smartphone size={14} />
                                                    <span className="text-[8px] font-bold uppercase">手机</span>
                                                </button>
                                                <button
                                                ...
                                                >
                                                    <Monitor size={14} />
                                                    <span className="text-[8px] font-bold uppercase">电脑</span>
                                                </button>
                                                <button
                                                ...
                                                >
                                                    <UserCircle size={14} />
                                                    <span className="text-[8px] font-bold uppercase">头像</span>
                                                </button>
                                            </div>
                                            ...
                                            <div className="flex gap-2">
                                                <button
                                                    ...
                                                    className="flex-1 py-3 bg-indigo-600 text-white rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-indigo-700 transition-all flex items-center justify-center gap-2"
                                                >
                                                    <Download size={12} /> 下载
                                                </button>
                                                <button
                                                    onClick={() => handleOpenSubmit(task)}
                                                    className="px-3 bg-white text-indigo-600 rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-gray-100 transition-all flex items-center gap-1.5"
                                                >
                                                    <Send size={12} /> 发布
                                                </button>
                                            </div>
                ...
                {showSubmitModal && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/40 backdrop-blur-sm">
                        <motion.div
                            ...
                            className="bg-white w-full max-w-xl rounded-[32px] overflow-hidden shadow-2xl border border-white/20"
                        >
                            <div className="flex h-[450px]">
                                ...
                                <div className="flex-1 p-8 flex flex-col relative">
                                    ...
                                    <div className="mb-8">
                                        ...
                                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-0.5 italic">Submit to Global Gallery</p>
                                    </div>

                                    <form onSubmit={handleSubmitForReview} className="flex-1 space-y-5 overflow-y-auto hide-scrollbar pr-1">
                                        <div className="space-y-1.5">
                                            <label className="text-[9px] font-black text-gray-400 uppercase tracking-widest ml-1">作品标题 (必填)</label>
                                            <input
                                                required
                                        ...
                                        <div className="space-y-1.5">
                                            <label className="text-[9px] font-black text-gray-400 uppercase tracking-widest ml-1">选择分类 (必选)</label>
                                        ...
                                        <div className="space-y-1.5">
                                            <label className="text-[9px] font-black text-gray-400 uppercase tracking-widest ml-1">常用标签 (多选)</label>
                                            <div className="flex flex-wrap gap-1.5">
                                                {tags.map(tag => (
                                                    <button
                                                        key={tag.id}
