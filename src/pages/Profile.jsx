...
function MenuItem({ icon, color, label, to = "/" }) {
    return (
        <Link to={to} className="bg-white p-4 rounded-xl flex items-center justify-between shadow-sm cursor-pointer border border-gray-50 hover:bg-gray-50 active:scale-[0.99] transition block">
